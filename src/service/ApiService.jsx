...
export default class ApiService {
    ...
    static BASE_URL = "https://hspace-server-deployment-latest.onrender.com"
    ...
    static async getAvailableRoomsByDateAndType(checkInDate, checkOutDate, roomType) {
        const result = await axios.get(
            `${this.BASE_URL}/rooms/available-rooms-by-dates-and-types?checkInDate=${checkInDate}&checkOutDate=${checkOutDate}&roomType=${roomType}`
        )
        return result.data
    }
    ...
    static async getRoomById(roomId) {
        const result = await axios.get(`${this.BASE_URL}/rooms/get-room-by-id/${roomId}`)
        return result.data
    }
